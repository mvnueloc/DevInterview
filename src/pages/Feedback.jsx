...
function FeedbackPage() {
  ...
  const { feedback, setLoadingFeedback, setErrorFeedback, setDoneFeedback } =
  ...
  return (
    <motion.main
      ...
      className="relative font-onest px-4 py-10 base:pb-20 base:pt-24 min-h-screen max-w-dwv text-gray-100">
