    ...
    return(
        <SkeletonTheme baseColor="#202020" highlightColor="#444">
            <div className="md:px-6 py-6 rounded-lg">
                <h2 className="mb-6 text-3xl font-bold border-b border-white">Código</h2>
                <div className="flex flex-col  gap-3 justify-between w-full base:flex-row base:items-stretch">
                    <div className="w-full flex flex-col p-6 min-h-64 bg-[#1B1D20] rounded-lg">
                        ...
                        <div className="mt-2">
                            Métricas del código proporcionado
                        </div>
                                ...
                                <div className="relative w-full flex flex-col sm:flex-row justify-between">
                                    ...
                                    <GaugeChart 
                                        ...
                                        data={
                                            ...
                                            data.metrics[0].funcionalidad ? data.metrics[0].funcionalidad : 0
                                        } 
                                        title="Funcional"
                                    />
                                    <GaugeChart 
                                        ...
                                        data = {
                                            data.metrics.length === 0 ? 0 :
                                            data.metrics[0].eficiencia ? data.metrics[0].eficiencia : 0
                                        } 
                                        title = "Eficiencia"
                                    />
                                    <GaugeChart 
                                        ...
                                        data={
                                            data.metrics.length === 0 ? 0 :
                                            data.metrics[0].legibilidad ? data.metrics[0].legibilidad : 0
                                        } 
                                        title="Legibilidad"
                                    />
                                    ...
                                    questions.length === 3 ? (
                                        <>
                                            ...
                                            <ReactMarkdown
                                                ...
                                                >
                                                {` \`\`\`${markdownLanguage}\n${questions[2] && questions[2]["Respuesta"] ? questions[2]["Respuesta"] : ""}\n\`\`\` `}
                                            </ReactMarkdown>
