    ...
    <div className="w-full py-20">
      <div className="">
        ...
        <p className="m-auto max-w-3xl text-center my-10">
          Recibe feedback detallado con métricas detalladas para que puedas
          mejorar tus habilidades técnicas y conseguir el trabajo de tus sueños.
        </p>
      </div>
      <div className="w-full flex flex-col gap-10 base:flex-row base:gap-0">
        ...
        <div className="flex-1 overflow-x-hidden">
          <FadeInRight>
            <img
              src="images/stats-landing.png"
              alt="Estadísticas Ejemplo"
              className="w-full rounded-xl md:max-h-[28rem] md:object-cover"
            />
          </FadeInRight>
        </div>
      </div>
