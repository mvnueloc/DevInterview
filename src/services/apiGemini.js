...
async function generarRespuesta(prompt) {
  try {
    const response = await generateText({
      ...
      Los criterios para evaluar son: Precisión: La respuesta es correcta y completa. Completitud: La respuesta debe abordar todos los aspectos relevantes de la pregunta o tema. Lógica: La respuesta es coherente y bien razonada. Claridad: La respuesta es fácil de entender y no tiene ambigüedades. Creatividad: La respuesta demuestra originalidad e ingenio          
